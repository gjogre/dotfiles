...
hl.config({
    general = {
        ...
        border_size = 1,
        col = {
            active_border   = { colors = { "rgba(BF40BFee)", "rgba(BF40BFee)" }, angle = 45 },
            inactive_border = "rgba(702963aa)",
        },
...
-- Remote/controller binds (gjbinds)
...
hl.bind("CTRL + Delete", hl.dsp.window.close())
